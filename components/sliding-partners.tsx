          ...
          {[...partners, ...partners, ...partners, ...partners].map((partner, index) => (
            ...
            >
              <img
                src={partner.logo}
                alt={partner.name}
                className="h-16 sm:h-20 md:h-22 lg:h-24 w-auto object-contain rounded-2xl transition-transform duration-500 hover:scale-125 hover:-translate-y-2 drop-shadow-[0_0_15px_rgba(239,68,68,0.6)]"
              />
            </div>
          ))}
        </div>
